...
parser.add_argument('--encoder-head', type=str, default='A', choices=['A', 'B', 'C'],
                    help='encoder head type')
parser.add_argument('--num-refinenet', type=int, default=2, choices=[2, 3],
                    help='number of refinenet in decoder')
